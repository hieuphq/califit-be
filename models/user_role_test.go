...
func testUserRoleToOneUserUsingUser(t *testing.T) {
	...
	seed := randomize.NewSeed()
	if err := randomize.Struct(seed, &local, userRoleDBTypes, true, userRoleColumnsWithDefault...); err != nil {
		t.Errorf("Unable to randomize UserRole struct: %s", err)
	}
...
func testUserRoleToOneRemoveOpUserUsingUser(t *testing.T) {
	var err error
...
func testUserRoleToOneRemoveOpRoleUsingRole(t *testing.T) {
	var err error
...
var (
	userRoleDBTypes = map[string]string{`CreatedAt`: `timestamp with time zone`, `ID`: `uuid`, `RoleID`: `uuid`, `UpdatedAt`: `timestamp with time zone`, `UserID`: `uuid`}
	_               = bytes.MinRead
)
...
func testUserRolesUpdate(t *testing.T) {
	...
	if len(userRoleColumns) == len(userRolePrimaryKeyColumns) {
...
func testUserRolesSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(userRoleColumns, userRolePrimaryKeyColumns) {
		fields = userRoleColumns
	} else {
