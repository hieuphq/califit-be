...
func (o *Category) Classes(mods ...qm.QueryMod) classQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"class\".\"category_id\"=?", o.ID),
	)
...
func (categoryL) LoadClasses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(qm.From(`class`), qm.WhereIn(`category_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Category) AddClasses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Class) error {
	var err error
...
// Sets o.R.Category's Classes accordingly.
// Replaces o.R.Classes with related.
// Sets related.R.Category's Classes accordingly.
func (o *Category) SetClasses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Class) error {
	query := "update \"class\" set \"category_id\" = null where \"category_id\" = $1"
...
func (o *Category) RemoveClasses(ctx context.Context, exec boil.ContextExecutor, related ...*Class) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.CategoryID, nil)
		if rel.R != nil {
