...
var (
	permissionColumns               = []string{"id", "name", "model", "action", "created_at", "updated_at"}
	permissionColumnsWithoutDefault = []string{"id", "name", "model", "action"}
...
func (o *Permission) RolePermissions(mods ...qm.QueryMod) rolePermissionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"role_permission\".\"permission_id\"=?", o.ID),
	)
...
func (permissionL) LoadRolePermissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybePermission interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`role_permission`), qm.WhereIn(`permission_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Permission) SetRolePermissions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RolePermission) error {
	query := "update \"role_permission\" set \"permission_id\" = null where \"permission_id\" = $1"
...
func FindPermission(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Permission, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"permission\" where \"id\"=$1", sel,
	)
...
func (o *Permission) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"permission\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Permission) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"permission\" WHERE \"id\"=$1"
...
func PermissionExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"permission\" where \"id\"=$1 limit 1)"
