...
import (
	...
	"github.com/hieuphq/califit-be/goa/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "califit-be Backend API-cli",
		Short: `CLI client for the califit-be Backend API service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "califit-be.club", "API hostname")
	...
	c.UserAgent = "califit-be Backend API-cli/0"
